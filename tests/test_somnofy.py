...
class Properties:
    def __init__(self, client_id, client_id_file):
...
class TestSomnofy:
    ...
    def test_init(self, mock_set_auth):
        properties = Properties(client_id='test_client_id', client_id_file='/path/to/client_id_file')
    ...
    def test_init_no_client_id(self):
        properties = Properties(client_id=None, client_id_file='/path/to/client_id_file')
    ...
    def test_set_auth_with_valid_token(self, mock_oauth2session, mock_open, mock_exists):
        properties = Properties(client_id='test_client_id', client_id_file='/path/to/client_id_file')
    ...
    def test_set_auth_new_authorization(self, mock_open, mock_oauth2session, mock_input, mock_webbrowser):
        properties = Properties(client_id='test_client_id', client_id_file='/path/to/client_id_file')
